...
func (h *Handlers) Register(
	...
	tsr.SUB("/private-chats/:first/:second/chat/users/list", turbostreams.EmptyHandler)
	tsr.MSG("/private-chats/:first/:second/chat/users/list", handling.HandleTSMsg(h.r, ss))
