...
- PLANKTOSCOPE_MJPEGSTREAM, which should be the URL of the MJPEG stream from the Planktoscope.
...
PLANKTOSCOPE_MJPEGSTREAM='https://mjpeg-proxy.cloud.syngnathus.sargassum.world/' \
make run
```
