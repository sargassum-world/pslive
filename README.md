...
- INSTRUMENT_ADMIN, which should be the Ory Kratos identity id of the person who has full administrative control over the instrument, including delegation of permissions to other people.
...
```
INSTRUMENT_ADMIN='abcdefg-1234-5678'
